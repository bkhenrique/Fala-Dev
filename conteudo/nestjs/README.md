...
- [ ] [01 — O que é o NestJS e por que ele existe](aulas/01-o-que-e-nest.md)
- [ ] [02 — TypeScript, Decorators e Metadata](aulas/02-typescript-e-decorators.md)
- [ ] [03 — Módulos, Controllers e Providers](aulas/03-modulos-controllers-providers.md)
- [ ] [04 — Injeção de Dependência e IoC](aulas/04-injecao-de-dependencia.md)
- [ ] [05 — Ciclo de vida da requisição](aulas/05-ciclo-de-vida-da-requisicao.md)
- [ ] [06 — Validação, DTOs e Serialização](aulas/06-validacao-e-dtos.md)
- [ ] [07 — Autenticação e Autorização](aulas/07-autenticacao-e-autorizacao.md)
